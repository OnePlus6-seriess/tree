...
package com.awaken.device.OnePlusSettings.Preferences;
...
public class CustomSeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener,
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        if (mTrackingTouch && !mContinuousUpdates) {
            ...
            updateValueViews();
            int duration = 100;
            if (newValue != mMinValue && newValue != mMaxValue && mMinValue != mMaxValue) {
                duration = (int) (1 + 48 * (newValue - mMinValue) / (mMaxValue - mMinValue));
            }
            VibrationUtils.doHapticFeedbackForDuration(mContext, duration);
